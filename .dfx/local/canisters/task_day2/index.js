...
import { idlFactory } from './task_day2.did.js';
export { idlFactory } from './task_day2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TASK_DAY2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./task_day2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the task_day2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./task_day2.did.js")._SERVICE>}
 */
export const task_day2 = createActor(canisterId);
